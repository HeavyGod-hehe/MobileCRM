...
**Generated:** 2026-07-22 05:49:58
**Database:** `/tmp/crm_stress_bug18c.db` (0.4 MB)
...
- [PASS] **Purchases/expenses just after local midnight land in today's reports, not UTC-yesterday's** - OK (682ms)
...
- [PASS] **Mixed-activity ledger reconciliation (220 randomized transactions)** - OK (806ms)
- [PASS] **Concurrent double-sell on the same phone is rejected, not double-posted** - OK (891ms)
- [PASS] **Concurrent double-return on the same sale is rejected, not double-refunded** - OK (477ms)
- [PASS] **Concurrent double-return on the same purchase is rejected, not double-refunded** - OK (508ms)
...
- [PASS] **Negative cash guard blocks by default, allows through with force=True** - OK (689ms)
- [PASS] **Negative bank guard blocks a withdrawal by default, allows through with force=True** - OK (671ms)
- [PASS] **Negative cash guard also blocks a bank deposit that would overdraw the drawer** - OK (668ms)
- [PASS] **Reversing one side investment doesn't touch the partner's other top-ups** - OK (681ms)
- [PASS] **Side investment reversal refuses ambiguous pre-fix legacy data instead of guessing** - OK (671ms)
- [PASS] **License activation is hardware-bound; reuse on another machine fails** - OK (9ms)
- [PASS] **Forgot-password OTP flow end to end (SMTP transport mocked, real app logic)** - OK (2711ms)
- [PASS] **OTP verification locks out after too many wrong attempts** - OK (679ms)
- [PASS] **OTP expires after 10 minutes** - OK (674ms)
...
- [PASS] **Backup taken pre-migration restores and cleanly re-migrates after a schema bump** - OK (714ms)
- [PASS] **Restore succeeds cleanly with a concurrent open connection (no corruption)** - OK (705ms)
