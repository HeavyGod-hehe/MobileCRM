...
**Generated:** 2026-07-22 05:40:07
**Database:** `/tmp/crm_stress_bug15.db` (0.4 MB)
...
- [PASS] **Purchase + udhar ledger sync** - OK (8ms)
...
- [PASS] **Sale return refund is capped at what the customer actually paid** - OK (8ms)
- [PASS] **Purchases/expenses just after local midnight land in today's reports, not UTC-yesterday's** - OK (554ms)
...
- [PASS] **Concurrent double-sell on the same phone is rejected, not double-posted** - OK (872ms)
- [PASS] **Concurrent double-return on the same sale is rejected, not double-refunded** - OK (473ms)
- [PASS] **Concurrent double-return on the same purchase is rejected, not double-refunded** - OK (482ms)
...
- [PASS] **Negative bank guard blocks a withdrawal by default, allows through with force=True** - OK (571ms)
- [PASS] **Negative cash guard also blocks a bank deposit that would overdraw the drawer** - OK (589ms)
- [PASS] **Reversing one side investment doesn't touch the partner's other top-ups** - OK (586ms)
- [PASS] **Side investment reversal refuses ambiguous pre-fix legacy data instead of guessing** - OK (572ms)
- [PASS] **License activation is hardware-bound; reuse on another machine fails** - OK (9ms)
- [PASS] **Forgot-password OTP flow end to end (SMTP transport mocked, real app logic)** - OK (2348ms)
- [PASS] **Restore only touches the requesting user's rows, others untouched** - OK (1196ms)
- [PASS] **Restore rejects path traversal and another user's backup file** - OK (18ms)
- [PASS] **Backup taken pre-migration restores and cleanly re-migrates after a schema bump** - OK (634ms)
- [PASS] **Restore succeeds cleanly with a concurrent open connection (no corruption)** - OK (613ms)
