...
**Generated:** 2026-07-22 04:30:08
**Database:** `/tmp/crm_stress_bug5.db` (0.38 MB)
...
- [PASS] **Concurrent double-sell on the same phone is rejected, not double-posted** - OK (881ms)
...
- [PASS] **Forgot-password OTP flow end to end (SMTP transport mocked, real app logic)** - OK (2333ms)
...
- [PASS] **Backup taken pre-migration restores and cleanly re-migrates after a schema bump** - OK (745ms)
- [PASS] **Restore succeeds cleanly with a concurrent open connection (no corruption)** - OK (610ms)
